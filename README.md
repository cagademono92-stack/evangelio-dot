...
bash curl -sSL https://raw.githubusercontent.com/cagademono92-stack/evangelio-dot/main/bootstrap.sh | bash, just you need extrac the archive and give double click in the install.sh
