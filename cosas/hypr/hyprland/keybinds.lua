...
hl.bind("SUPER + SUPER_L", hl.dsp.exec_cmd(qsIsAlive .. " || pkill rofi || rofi -show drun"), { description = "App: Launcher (Rofi)" })
hl.bind("SUPER + SUPER_R", hl.dsp.exec_cmd(qsIsAlive .. " || pkill rofi || rofi -show drun"))
...
-- Cambiar wallpaper: waypaper (GUI) en vez del selector de Quickshell.
-- Recordá configurar el "post command" de waypaper (en su propio config.ini)
-- para que llame a `matugen image <wallpaper>` después de cada cambio manual.
hl.bind(
	"CTRL + SUPER + T",
	hl.dsp.exec_cmd("pkill waypaper || waypaper"),
