...
-- Cava audio visualizer (floating terminal, auto-shown by CavaAutoShow.sh)
hl.window_rule({match = {class = "^(cava-float)$" },                         float = true})
hl.window_rule({match = {class = "^(cava-float)$" },                         center = true})
hl.window_rule({match = {class = "^(cava-float)$" },                         size = {420, 200} })
hl.window_rule({match = {class = "^(cava-float)$" },                         no_shadow = true})
hl.window_rule({match = {class = "^(cava-float)$" },                         pin = true}) -- se queda visible aunque cambies de escritorio
...
-- Componentes reales que reemplazan a Quickshell
hl.layer_rule({ match = { namespace = "waybar" }, blur = true})
hl.layer_rule({ match = { namespace = "waybar" }, ignore_alpha = 0})
hl.layer_rule({ match = { namespace = "nwg-bar" }, blur = true})
hl.layer_rule({ match = { namespace = "nwg-bar" }, ignore_alpha = 0})
...
-- waybar (agregado: para que el blur del sistema se vea detrás de tu waybar/nwg-bar propios)
hl.layer_rule({ match = { namespace = "waybar" }, blur = true})
hl.layer_rule({ match = { namespace = "waybar" }, ignore_alpha = 0})
hl.layer_rule({ match = { namespace = "nwg-bar" }, blur = true})
hl.layer_rule({ match = { namespace = "nwg-bar" }, ignore_alpha = 0})
